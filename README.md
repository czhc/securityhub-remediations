...
3. Setup AWS credentials for the Cloud9 environment
    ...
    16. If you get AccessDenied, then review the edits (usual suspects are leaving the braces in, or including dashes in the account number) you made to ~/.aws/config and step 5 as you need to have working credentials for CloudCustodian to be able to make aws api calls.
...
1. Run the following:
```
docker run -it -v /home/ec2-user/environment/securityhub-remediations/output:/home/custodian/output -v /home/ec2-user/environment/securityhub-remediations:/home/custodian/securityhub-remediations:ro -v /home/ec2-user/.aws/config:/home/custodian/.aws/config:ro cloudcustodian/c7n run --cache-period 0 -s /home/custodian/output --profile cc -c /home/custodian/securityhub-remediations/module2/ec2-sechub-custom-action.yml
```
...
```
docker run -it -v /home/ec2-user/environment/securityhub-remediations/output:/home/custodian/output -v /home/ec2-user/environment/securityhub-remediations:/home/custodian/securityhub-remediations:ro -v /home/ec2-user/.aws/config:/home/custodian/.aws/config:ro cloudcustodian/c7n run --cache-period 0 -s /home/custodian/output --profile cc -c /home/custodian/securityhub-remediations/module3/ec2-sechub-remediate-severity-with-findings.yml
...
```
docker run -it -v /home/ec2-user/environment/securityhub-remediations/output:/home/custodian/output -v /home/ec2-user/environment/securityhub-remediations:/home/custodian/securityhub-remediations:ro -v /home/ec2-user/.aws/config:/home/custodian/.aws/config:ro cloudcustodian/c7n run --cache-period 0 -s /home/custodian/output --profile cc -c /home/custodian/securityhub-remediations/module4/ec2-public-ingress-hubfinding.yml
docker run -it -v /home/ec2-user/environment/securityhub-remediations/output:/home/custodian/output -v /home/ec2-user/environment/securityhub-remediations:/home/custodian/securityhub-remediations:ro -v /home/ec2-user/.aws/config:/home/custodian/.aws/config:ro cloudcustodian/c7n run --cache-period 0 -s /home/custodian/output --profile cc -c /home/custodian/securityhub-remediations/module1/force-vulnerability-finding.yml  
```
...
1. Run the following commands:
```
docker run -it -v /home/ec2-user/environment/securityhub-remediations/output:/home/custodian/output -v /home/ec2-user/environment/securityhub-remediations:/home/custodian/securityhub-remediations:ro -v /home/ec2-user/.aws/config:/home/custodian/.aws/config:ro cloudcustodian/c7n run --cache-period 0 -s /home/custodian/output --profile cc -c /home/custodian/securityhub-remediations/module5/iam-user-hubfinding-remediate-disable.yml
